...
- [x] **[1. To be is to be the value of a variable](./1-print_numbers.c)** - Write a function that prints numbers, followed by a new line.
- [x] **[2. One woman's constant is another woman's variable](./2-print_strings.c)** - Write a function that prints strings, followed by a new line.
